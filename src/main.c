...
void drawBox( int x, int y , Uint32 color) {
    ...
    filledCircleColor(sdlRenderer, (width1+(width1 + SCREEN_WIDTH / CELL_NUM))/2, (height1+(height1 + SCREEN_HEIGHT / CELL_NUM))/2, 3 , colorc);
...
//    SDL_Texture *text;
    ...
    Sint16 vx[6] = {120, 150, 200, 230, 200, 150};
    Sint16 vy[6] = {100, 60, 60, 100, 140, 140};
    //char text[30] = {" "};
    Sint16 tool = 233;
    int i = 0;
